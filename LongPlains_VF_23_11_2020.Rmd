...
I have worked out when the VF has become active and for fence 3 when it is active and deactive. 
Using this date time pulled out a window of time close to the femce move.
...
When you look at the plots it appears an animals was alraedy there!
...
week1_2_3_activity %>%
  ...
  labs(
    x = "Mob",
    y = "% time attributed to activity",
    title = paste("Behaviour for all animals")
  )
#Another plot option
