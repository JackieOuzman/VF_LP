...
- total gain (check the units ? grams)
...
Jackie is it worth trying to do that new map idea the reviewer suggested last time with the behaviours matched to paddock location? 

(I don’t think that was in the attached document). 

- Calibartion curves

- Explore more with animals activity data
