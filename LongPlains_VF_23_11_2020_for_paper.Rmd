...
week1_2_3_rest$local_time <- as.POSIXct(week1_2_3_rest$local_time, format = "%Y-%m-%d %H:%M:%S", tz= "Australia/Adelaide")
...
seq(as.POSIXct(min(week1_2_3_rest$round_local_time), format = "%Y-%m-%d %H:%M:%S", tz= "Australia/Adelaide"), #start time
    as.POSIXct(max(week1_2_3_rest$round_local_time), format = "%Y-%m-%d %H:%M:%S", tz= "Australia/Adelaide"), #end time
    dminutes(10)) #inteval 
)
...
#change the local time to correct format
week1_2_3_rest_control$local_time <- as.POSIXct(week1_2_3_rest_control$local_time, format = "%Y-%m-%d %H:%M:%S", tz= "Australia/Adelaide")
