...
#### Run an t-test on behaviors?

- Are open graze animals doing more resting than the VF animals?
- Are open graze animals doing more grazing than the VF animals?
- Are open graze animals doing more moving than the VF animals?
...
### refer to R markdown Resting_spots_Dec2021_analysis.Rmd 
The below code won't run.
I can get all working in another document.
Very frustrating!
...
```{r write up resting spots working_version1, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r write resting spots working control animals, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
#step1 one pull out the all the resting data only.
...
```{r write up resting spots results_version1 making plots, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r write up resting spots results_version1, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
